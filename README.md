...
<td align="left">Boolean that specifies whether the results of time_n_test should be saved to the current directory. Default is time_n_test=FALSE.</td>
</tr>
<tr class="even">
...
<td align="left">vector of parameter names to be stacked in the rows of the table. Ordered from inner to outer.</td>
</tr>
<tr class="odd">
<td align="center">cols</td>
<td align="left">vector of parameter names to be stacked in the cols of the table. Ordered from inner to outer.</td>
</tr>
<tr class="even">
...
```
    ...
    ## }
    ## 
    ## Required time: 12.15 secs for nrep = 1000  repetitions on 1 CPUs 
    ## 
    ## Parameter grid: 
    ## 
    ##      n : 50 100 250 500 
...
```
    ...
    ##  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
    ## 50 &  & 0.06 & 0.34 & 0.79 & 0.99 & 1.00 & 1.00 &  & 0.06 & 0.11 & 0.29 & 0.57 & 0.81 & 0.93 \\ 
    ## 100 &  & 0.04 & 0.48 & 0.98 & 1.00 & 1.00 & 1.00 &  & 0.05 & 0.19 & 0.49 & 0.84 & 0.98 & 1.00 \\ 
    ## 250 &  & 0.05 & 0.90 & 1.00 & 1.00 & 1.00 & 1.00 &  & 0.06 & 0.35 & 0.87 & 1.00 & 1.00 & 1.00 \\ 
    ## 500 &  & 0.06 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 &  & 0.04 & 0.59 & 0.99 & 1.00 & 1.00 & 1.00 \\ 
    ## \\
    ## \\
    ## \hline\hline
    ## \end{tabular}%
...
```
    ...
    ##  &  &  &  &  &  &  &  &  \\ 
    ## \multirow{ 4 }{*}{ 1 } & 50 &  & 0.06 & 0.34 & 0.79 & 0.99 & 1.00 & 1.00 \\ 
    ##  & 100 &  & 0.04 & 0.48 & 0.98 & 1.00 & 1.00 & 1.00 \\ 
    ##  & 250 &  & 0.05 & 0.90 & 1.00 & 1.00 & 1.00 & 1.00 \\ 
    ##  & 500 &  & 0.06 & 1.00 & 1.00 & 1.00 & 1.00 & 1.00 \\ 
    ##  &  &  &  &  &  &  &  &  \\ 
    ## \multirow{ 4 }{*}{ 2 } & 50 &  & 0.06 & 0.11 & 0.29 & 0.57 & 0.81 & 0.93 \\ 
    ##  & 100 &  & 0.05 & 0.19 & 0.49 & 0.84 & 0.98 & 1.00 \\ 
    ##  & 250 &  & 0.06 & 0.35 & 0.87 & 1.00 & 1.00 & 1.00 \\ 
    ##  & 500 &  & 0.04 & 0.59 & 0.99 & 1.00 & 1.00 & 1.00 \\ 
    ## \\
    ## \\
    ## \hline\hline
    ## \end{tabular}%
